...
import { SEARCH_USERS, GET_USER, GET_REPOSITORIES, CLEAR_USERS, SET_LOADING } from '../types'
...
export const GithubState = ({children}) => {
    ...
    const getRepositories = async name => {
        ...
        const response = await axios.get(
            withCredentials(`https://api.github.com/users/${name}/repos?per_page=10&`)
        )
    ...
    return (
        <GithubContext.Provider value={{
            search, getUser, getRepositories, setLoading, clearUsers,
